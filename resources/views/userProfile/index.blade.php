            ...
            <div class="card my-4">
                ...
                <div class="btn-group btn-group-toggle m-3" data-toggle="buttons">
                    <label class="btn bg-gradient-primary active p-2">
                        <input type="radio" name="options" id="option1" autocomplete="off" checked> Posts
                    </label>
                    <label class="btn text-gradient-primary btn-outline-dark p-2">
                        <input type="radio" name="options" id="option2" onclick="Profile() " autocomplete="off"> Requests
                    </label>
                </div>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            var table = $('#dataTable').DataTable({
                "processing": true,
                "serverSide": true,
                "ajax": '{{ route('profile.getPostsData',$id) }}',
        ...
        function Profile(){
            window.location.href = "/profileRequests/{{$id}}";
        }
    </script>
